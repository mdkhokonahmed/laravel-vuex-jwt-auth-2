                ...
                <div class="sidebar-inner slimscrollleft">
                    <div class="user-details">
                        <div class="text-center">
                            <img src="custom/assets/images/users/avatar-1.jpg" alt="" class="img-circle">
                        </div>
                        <div class="user-info">
                            <div class="dropdown">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            <li>
                                <router-link :to="{ name: 'dashboard' }"><i class="ti-home"></i><span> Dashboard </span></router-link>
                            </li>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="ti-agenda"></i> <span> All Members </span> <span class="pull-right"><i class="mdi mdi-plus"></i></span></a>
                                <ul class="list-unstyled">
                                    <li>
                                    <router-link :to="{ name: 'allmember' }">All Members</router-link>
